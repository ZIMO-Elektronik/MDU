...
TEST_F(PointTest, firmware_entry) {
  ...
  verify({{8u - 1u, 255},
          {105u - 1u, (decoder_id_ & 0xFF00'0000u) >> 24u},
          {106u - 1u, (decoder_id_ & 0x00FF'0000u) >> 16u},
          {105u - 1u, (decoder_id_ & 0x0000'FF00u) >> 8u},
          {106u - 1u, (decoder_id_ & 0x0000'00FFu) >> 0u},
          {105u - 1u, 0u},
          {106u - 1u, 0u}});
}
...
TEST_F(PointTest, firmware_wrong_index) {
  ...
  verify({{8u - 1u, 255},
          {105u - 1u, (decoder_id_ & 0xFF00'0000u) >> 24u},
          {107u - 1u, (decoder_id_ & 0x00FF'0000u) >> 16u},
          {105u - 1u, (decoder_id_ & 0x0000'FF00u) >> 8u},
          {106u - 1u, (decoder_id_ & 0x0000'00FFu) >> 0u},
          {105u - 1u, 0u},
          {106u - 1u, 0u}});
