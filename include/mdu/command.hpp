...
enum class Command : uint32_t {
  ...
  Busy = 0xFFFF'FFF2u,
  ZsuSalsa20IV = 0xFFFF'FFF7u,
  ZsuErase = 0xFFFF'FFF5u,
  ZsuUpdate = 0xFFFF'FFF8u,
  ZsuCrc32Start = 0xFFFF'FFFBu,
  ZsuCrc32Result = 0xFFFF'FFFCu,
  ZsuCrc32ResultExit = 0xFFFF'FFFDu,
